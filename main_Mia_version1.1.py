...
# SMALL BUG:: to continue the project, enter your numbers, press enter, then
# close the window. the program will continue after being closed.
...
output = Label(master, text = "Please enter pattern numbers separated by spaces. "
...
ou2 = Label(next, text = "Final equation " + teststr)
ou2.pack()

ou3 = Label(next, text = "Let's break this down")
ou3.pack()
